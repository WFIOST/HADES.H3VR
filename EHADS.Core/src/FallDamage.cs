...
namespace EHADS.Core
{
    public class FallDamage : MonoBehaviour
    {
        ...
        private void Start()
        {
            if (!EHADSConfig.FallDamageConfig.Enabled) Print("Injected FallDamage into player");
        }

        private void Update()
        {
            if (GM.IsDead() || !EHADSConfig.FallDamageConfig.Enabled) return;
        ...
        private Tuple<float, float> CalculateFallDamage()
        {
            ...
            float effectiveVelocity = _velocityDifference + EHADSConfig.FallDamageConfig.FallHeight * 0.02f;
            ...
            {
                damage = effectiveVelocity * EHADSConfig.FallDamageConfig.FallHeight;
            }
